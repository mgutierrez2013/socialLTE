...
import com.clobi.socialmedia.controller.util.JsfUtil.PersistAction;
...
public class PaginasController implements Serializable {
    ...
    public void filtrarPostFechas(){
        ...
        setListaPost(ejbFacade.obtenerPostFiltroFecha(selected.getId(),fechaIni, fechaFin));
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("PaginasCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("PaginasUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("PaginasDeleted"));
        if (!JsfUtil.isValidationFailed()) {
